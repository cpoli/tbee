...
class TestEigTB(unittest.TestCase):
    ...
    def test_errors_print_hops(self):
    ...
    def test_errors_set_onsite(self):
        # on must be a list of numbers.
        eig = init()
        self.assertRaises(TypeError, eig.set_onsite, 0)
        self.assertRaises(ValueError, eig.set_onsite, [b'a'])
    ...
    def test_set_dimerization_def(self):
        ...
        self.assertRaises(TypeError, eig.set_dimerization_def, 'ab', 4, 0)
        self.assertRaises(TypeError, eig.set_dimerization_def, b'ab', 'a', 0)
        self.assertRaises(TypeError, eig.set_dimerization_def, b'ab', 4, 'a')
        self.assertRaises(ValueError, eig.set_dimerization_def, b'zb', 4, 0)
        self.assertRaises(ValueError, eig.set_dimerization_def, b'b', 4, 0)
    ...
    def test_errors_set_disorder_on(self):
        eig = init()
        # alpha must be a positive number.
        self.assertRaises(TypeError, eig.set_on_disorder, 0j)
        self.assertRaises(ValueError, eig.set_on_disorder, 0)
